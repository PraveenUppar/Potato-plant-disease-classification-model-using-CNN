...
def prediction(image_path, class_names=['Potato___Early_blight', 'Potato___Late_blight', 'Potato___healthy']):
    ...
    # Correct the model path - use one of these options:
    # Option 1: If model is in the same directory as your script
    model_path = 'model.h5'
    
    # Option 2: If model is in a 'models' subdirectory
    # model_path = 'models/model.h5'
    
    # Option 3: Absolute path (replace with your actual path)
    # model_path = r'C:\Users\Asus\Desktop\Potato-Disease-Classification-using-Deep-Learning\model.h5'
    ...
    st.markdown(f'<h4 style="color: orange;">Predicted Class : {predicted_class}', 
                unsafe_allow_html=True)
    #  add_vertical_space(1)
